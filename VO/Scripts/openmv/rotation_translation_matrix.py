...
# JACOBI EIGEN DECOMPOSITION (for symmetric NxN)
...
# Solve A f = 0 for Nx9 matrix A .
# We'll do it by finding the smallest eigenvalue/eigenvector of A^T A (9x9).
...
################################################################################
# SVD for 3x3 using eigen decomposition.
#  - B = A^T A => V and S^2
#  - B2 = A A^T => U and S^2
...
# Decompose essential matrix: E = U diag(1,1,0) V^T => R, T
